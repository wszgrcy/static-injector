  ...
  implements o.StatementVisitor, o.ExpressionVisitor
{
  ...
  abstract visitDeclareClassStmt(
    stmt: o.ClassStmt,
    ctx: EmitterVisitorContext
  ): any;
  ...
  abstract visitFunctionExpr(
    ast: o.FunctionExpr,
    ctx: EmitterVisitorContext
  ): any;
  abstract visitDeclareFunctionStmt(
